...
<!-- VISUAL: concept-diagram | id:bottleneck-shift-map | purpose: Show the shift from code-production bottlenecks to context, governance, integration, and decision quality in the AI era. -->
...
<!-- VISUAL: comparison-table | id:framework-map-ai-era | purpose: Compare Lean, Agile, ITIL, PMBOK, BABOK, and the Sane operating posture by what problem each addresses, what each sees clearly, and how each can fail when misused. -->
